...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ESS Account Credentials</title>
    <style>
        body {
            margin: 0;
            padding: 0;
                ...
                <td style="padding: 30px;">
                    ...
                    <div style="background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 5px; padding: 20px; margin: 20px 0;">
                        <div style="margin: 10px 0;">
                            <span style="font-weight: bold; color: #002444;">Employee ID:</span>
                            <span>${data?.empId}</span>
                        </div>
                        <div style="margin: 10px 0;">
                            <span style="font-weight: bold; color: #002444;">Email:</span>
                            <span>${data?.email}</span>
                        </div>
                        <div style="margin: 10px 0;">
                            <span style="font-weight: bold; color: #002444;">Temporary Password:</span>
                            <span>Easy@1122</span>
                        </div>
                    </div>
